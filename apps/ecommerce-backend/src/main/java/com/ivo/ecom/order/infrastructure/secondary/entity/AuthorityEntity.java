package com.ivo.ecom.order.infrastructure.secondary.entity;


import com.ivo.ecom.order.domain.user.aggregate.Authority;
import com.ivo.ecom.order.domain.user.aggregate.AuthorityBuilder;
