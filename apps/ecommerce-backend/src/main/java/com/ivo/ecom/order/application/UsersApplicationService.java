package com.ivo.ecom.order.application;

import com.ivo.ecom.order.domain.user.aggregate.User;
import com.ivo.ecom.order.domain.user.repository.UserRepository;
import com.ivo.ecom.order.domain.user.service.UserReader;
import com.ivo.ecom.order.domain.user.service.UserSynchronizer;
import com.ivo.ecom.order.domain.user.vo.UserAddressToUpdate;
import com.ivo.ecom.order.domain.user.vo.UserEmail;
import com.ivo.ecom.order.infrastructure.secondary.service.kinde.KindeService;
import com.ivo.ecom.shared.authentication.application.AuthenticatedUser;
